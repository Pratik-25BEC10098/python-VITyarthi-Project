...
Nutritional Details. Calculates the total intake of Calories, Protein, Carbohydrates, and Fat.  
...
Save the Code  
Save the provided python code into a file named ‘nutrition_calculator.py’.  
Run the script  
Open your terminal or command prompt, navigate to directory where you saved the file, and execute the script using the python interpreter.
